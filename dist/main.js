...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
const bodies = __webpack_require__(/*! ./data/bodies.json */ "./src/data/bodies.json");
const driver = __webpack_require__(/*! ./data/driver.json */ "./src/data/driver.json");
const driverModel = __webpack_require__(/*! ./data/driverModel.json */ "./src/data/driverModel.json");
const gliders = __webpack_require__(/*! ./data/gliders.json */ "./src/data/gliders.json");
const tires = __webpack_require__(/*! ./data/tires.json */ "./src/data/tires.json");
const tracks = __webpack_require__(/*! ./data/MarioKart8Tracks.json */ "./src/data/MarioKart8Tracks.json");
